...
<body>
	<h1> Cadena de Hotel PeruInka</h1>
	<header>
		<h1>
			<a href="index.html">
		...
		<nav>
			<ul>
				...
				<li> <a href="home/dashboardC">M.Sucursal</a> </li>
				<li> <a href="acerca.html">M.Clientes</a> </li>
				<li> <a href="servicios.html">M.Productos</a> </li>
				<li> <a href="trabajos.html">Habitaciones</a> </li>
